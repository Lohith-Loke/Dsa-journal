...
def carAssembly(a, t, e, x):
    ...
    print(f'assembley line 1 cost :{T1}')
    print(f'path taken to achive min cost {line1}\n\n')

    print(f'assembley line 2 cost :{T2}')
    print(f'path taken to achive min cost {line2}\n\n')
